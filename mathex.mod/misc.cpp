...
extern "C"{
	void C_UpdateNormals(int,int,int *,float *,float *);
...
int TriangleVertex(int,int,int*);

void C_UpdateNormals(int no_tris,int no_verts,int *tris,float *vert_coords,float *vert_norm){
...
int TriangleVertex(int tri_no,int corner,int* tris){
